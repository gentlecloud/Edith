...
class EdithSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // 菜单
        EdithMenu::insert([
            ['name' => '控制台', 'guard_name' => 'basic', 'icon' => 'icon-kongzhitaishouye', 'type' => 'default', 'parent_id' => 0, 'sort' => 0, 'path' => '/dashboard', 'component' => null, 'is_dev' => 0],
            ['name' => '主页', 'guard_name' => 'basic', 'icon' => 'icon-shouye', 'type' => 'engine', 'parent_id' => 1, 'sort' => 0, 'path' => 'index', 'component' => 'Engine', 'is_dev' => 0],

            ['name' => '管理员', 'guard_name' => 'admin', 'icon' => 'icon-guanliyuan', 'type' => 'default', 'parent_id' => 0, 'sort' => 2, 'path' => '/auth', 'component' => null, 'is_dev' => 0],
            ...
            ['name' => '系统配置', 'guard_name' => 'admin', 'icon' => 'icon-setting', 'type' => 'default', 'parent_id' => 0, 'sort' => 4, 'path' => '/system', 'component' => null, 'is_dev' => 0],
